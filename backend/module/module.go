...
import (
	...
	"github.com/brickKit/erp-finance/backend/internal/consumer"
	grpcapi "github.com/brickKit/erp-finance/backend/internal/grpc"
	httpapi "github.com/brickKit/erp-finance/backend/internal/http"
	"github.com/brickKit/erp-finance/backend/internal/partition"
	"github.com/brickKit/erp-finance/backend/internal/repo"
	"github.com/brickKit/erp-finance/backend/internal/service"
	"github.com/brickKit/erp-finance/migrations"
)
...
func New(ctx context.Context, rt *besdk.Runtime) (*besdk.Module, error) {
	...
	schema := rt.Config.StringOr("pgSchema", "erp_finance")
	role := schema + "_rw"
